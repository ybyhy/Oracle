...
```
![](https://github.com/ybyhy/Oracle/blob/master/test4/1.png)
```
select * from ORDER_DETAILS where  order_id=1;
```
![](https://github.com/ybyhy/Oracle/blob/master/test4/2.png)
```
select * from VIEW_ORDER_DETAILS where order_id=1;
```
![](https://github.com/ybyhy/Oracle/blob/master/test4/3.png)
 #### 2.递归查询某个员工及其所有下属，子下属员工。
```
...
SELECT * FROM A;
```
![](https://github.com/ybyhy/Oracle/blob/master/test4/4.png)
 #### 3.查询分区表情况
```
select TABLE_NAME,PARTITION_NAME,HIGH_VALUE,PARTITION_POSITION,TABLESPACE_NAME from user_tab_partitions
```
![](https://github.com/ybyhy/Oracle/blob/master/test4/5.png)
 #### 4.查询分区索引情况
```
select * from USER_IND_PARTITIONS;
```
![](https://github.com/ybyhy/Oracle/blob/master/test4/6.png)
 #### 5.查询一个分区中的数据
```
select count(*) from ORDERS partition(PARTITION_BEFORE_2016);
```
![](https://github.com/ybyhy/Oracle/blob/master/test4/7.png)
```
select count(*) from ORDERS partition(PARTITION_BEFORE_2017);
```
![](https://github.com/ybyhy/Oracle/blob/master/test4/8.png)
 #### 6.统计用户的所有表，统计完成后，查询表的统计信息
```
...
```
![](https://github.com/ybyhy/Oracle/blob/master/test4/9.png)
![](https://github.com/ybyhy/Oracle/blob/master/test4/10.png)
![](https://github.com/ybyhy/Oracle/blob/master/test4/11.png)
![](https://github.com/ybyhy/Oracle/blob/master/test4/12.png)
![](https://github.com/ybyhy/Oracle/blob/master/test4/13.png)
